...
*   AI provides 3 auto generated ideas which is added to todo list automaticly.
...
-Add a footer with the foodprint.

#
-Do not do anything else if you are not sure! After test complation you can proceed.
-Create a new file and add that into bugrakarsli.com
