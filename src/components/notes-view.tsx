...
const timelineData = [
    ...
    },
    {
        ...
        notes: [
            ...
            { id: 'note2', text: "You can use the following CURL command to fetch ideas: curl -X GET 'https://www.bugrakarsli.com/ideas' -H 'Authorization: Bearer your_token'", isLink: true },
        ]
    },
    {
        id: '2025-04-19',
