...
export const IdeasView = ({
  ...
  ideaInputRef: React.RefObject<HTMLInputElement>;
}) => {
        ...
        <div className="px-6 py-4">
          {ideas.length === 0 ? (
            <div className="text-center text-gray-500 py-10">
              ...
              <Button onClick={() => document.querySelector<HTMLInputElement>('input[placeholder="Add a new idea..."]')?.focus()} className="mt-4 bg-primary text-primary-foreground hover:bg-primary/90">
